        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-text-muted text-sm mb-4 leading-relaxed">
              An AI-powered learning platform transforming random learning into
              an organized journey toward professional success
            </p>
          </div>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-bold mb-4 text-text-foreground">Contact Us</h4>
