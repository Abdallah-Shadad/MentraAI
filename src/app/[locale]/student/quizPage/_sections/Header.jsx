    ...
    <header className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <h1 className="mt-2 text-3xl sm:text-4xl font-semibold text-text-foreground">
            Module 2 Assessment
...
function Pill({ icon, children }) {
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full border border-border bg-bg-card/60 px-3 py-1 text-xs text-text-secondary">
      {icon}
      {children}
    </span>
  );
