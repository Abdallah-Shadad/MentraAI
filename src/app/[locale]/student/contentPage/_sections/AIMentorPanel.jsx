...
export default function AIMentorPanel() {
  return (
    <aside className="hidden xl:flex w-[340px] shrink-0 flex-col border-l border-border bg-bg-card/60 backdrop-blur-xl">
      {/* Mentor header */}
      <div className="p-6 border-b border-border">
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <span className="absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full bg-success border-2 border-bg-card" />
          </div>
          <div>
        ...
        <div className="mt-5 rounded-lg border border-primary/20 bg-primary/5 p-4">
          <p className="text-sm leading-relaxed text-foreground/90">
            You're doing great,{" "}
            <span className="text-primary-light font-medium">Sara</span>. Your
            pace on gradient concepts is above average.
          </p>
          <div className="mt-3 flex items-center gap-1 text-xs text-muted-foreground">
            <span className="ai-dot h-1.5 w-1.5 rounded-full bg-primary" />
            <span className="ai-dot h-1.5 w-1.5 rounded-full bg-primary" />
            <span className="ai-dot h-1.5 w-1.5 rounded-full bg-primary" />
      ...
      <div className="p-6 border-b border-border space-y-4">
        ...
        <div className="flex items-start gap-2.5 rounded-md border border-border bg-bg-tertiary/40 p-3">
      ...
      <div className="p-6 space-y-2.5 flex-1">
        ...
        <Button
          variant="outline"
          className="w-full justify-start gap-2.5 border-border hover:border-primary/40 hover:bg-primary/5 h-auto py-3"
        >
      ...
      <div className="p-4 border-t border-border">
        <div className="flex items-center gap-2 rounded-md border border-border bg-bg-tertiary/60 px-3 py-2.5 focus-within:border-primary/40 transition-fast">
          ...
          />
          <kbd className="text-[10px] text-muted-foreground border border-border-strong rounded px-1.5 py-0.5">
            ⌘K
          </kbd>
        </div>
      </div>
