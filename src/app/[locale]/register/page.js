...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col pt-12 items-center justify-center bg-background gap-8 relative overflow-hidden">
      <BackgroundNodes />
      {/* Logo */}
      <div className="inline-flex mx-auto items-center gap-2 px-4 py-1 rounded-full border border-purple-500/40 bg-purple-500/10">
        <div className="w-2.5 h-2.5 bg-purple-500 rounded-full shadow-[0_0_8px_rgba(139,92,246,.7)]" />
        <span className="text-purple-300 text-sm font-semibold">MentarAI</span>
      </div>
      ...
      {steps === 1 && (
        ...
        >
          <div className="w-full max-w-4xl mb-6">
            ...
            <LoginForm steps={steps} setSteps={setSteps} />
          </div>
        </motion.div>
      )}
      ...
      {steps === 3 && selectedOption === "option1" && (
        <div className="w-full max-w-4xl mb-6 min-h-screen">
          <button
            onClick={() => setSteps(steps - 1)}
